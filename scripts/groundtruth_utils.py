...
def MC_raw_data(
    ...
    if model_chosen[1]==1:
        ...
        noise_pressure = [0, 10]
        noise_humidity = [0, 2]
        edm_range, nl = edm_noise(range_value, lambda_edm, Measured_values, Nominal_values, noise_temp, noise_pressure, noise_humidity, num_samples)
...
def MC_raw_data_simulated_point(
    num_samples,
    range_value,
    random_noise_range,
    true_azimuth,
