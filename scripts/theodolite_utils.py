...
def save_MC_simulated(MC_simulated, output):
    MC_file = open(output, "w+")
    for i in MC_simulated:
        MC_file.write(str(i[0]))
        MC_file.write(" ")
        MC_file.write(str(i[1][0]))
        MC_file.write(" ")
...
def save_MC_pose_sorted(MC_sorted, output):
    MC_file = open(output, "w+")
    for i in MC_sorted:
        MC_file.write(str(i[0]))
        MC_file.write(" ")
        ...
        MC_file.write(str(i[2][2][2]))
        MC_file.write(" ")
        MC_file.write(str(i[3][0]))
        MC_file.write(" ")
        MC_file.write(str(i[3][1]))
        MC_file.write(" ")
        MC_file.write(str(i[3][2]))
        MC_file.write(" ")
        MC_file.write(str(i[4][0][0]))
        MC_file.write(" ")
        MC_file.write(str(i[4][0][1]))
        MC_file.write(" ")
        MC_file.write(str(i[4][0][2]))
        MC_file.write(" ")
        MC_file.write(str(i[4][1][0]))
        MC_file.write(" ")
        MC_file.write(str(i[4][1][1]))
        MC_file.write(" ")
        MC_file.write(str(i[4][1][2]))
        MC_file.write(" ")
        MC_file.write(str(i[4][2][0]))
        MC_file.write(" ")
